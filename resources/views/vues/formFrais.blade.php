        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 col-sm-2">
                    <input type="text" name="anneemois" value="{{$unFrais->anneemois}}" class="form-control"
                           placeholder="AAAAMM" required autofocus>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3">
                    <input type="currency" class="form-control" name="montantvalide" value="{{$unFrais->montantvalide}}"
                           placeholder="Montant engagé" required>
                    </label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                    <a href="{{ url('listeFraisHorsForfait') }}/{{$unFrais->id_frais}}">
